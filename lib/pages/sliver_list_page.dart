...
class SliverListPage extends StatelessWidget {
  static final routeName = 'SliverListPage';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        // body: _ListaTareas()
        body: Stack(
      children: <Widget>[_MainScroll(), Positioned(bottom: -10, right: 0, child: _BotonNewList())],
    ));
  }
}
      ...
      child: ElevatedButton(
        ...
        style: ButtonStyle(
            ...
            shape: MaterialStateProperty.all<RoundedRectangleBorder>(
                RoundedRectangleBorder(borderRadius: BorderRadius.only(topLeft: Radius.circular(50))))),
        child: Container(
...
class _ListaTareas extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return ListView.builder(itemCount: items.length, itemBuilder: (BuildContext context, int index) => items[index]);
  }
}
